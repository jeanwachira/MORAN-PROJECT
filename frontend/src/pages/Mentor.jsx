...
import { Plus, Trash2, Edit, Mail, Phone, User, Search, Filter, MoreVertical, Star } from 'lucide-react';
            ...
            <div className="bg-white rounded-3xl border border-stone-100 shadow-sm p-5 mb-6">
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <Select value={filterProfession} onValueChange={setFilterProfession}>
                        <SelectTrigger className="w-48 h-10 rounded-2xl border-stone-200">
                    ...
                    <div className="p-8">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                { id: 'profilepic', label: 'Profile Picture URL (Optional)', type: 'text', placeholder: 'Enter image URL' },
                            ].map(f => (

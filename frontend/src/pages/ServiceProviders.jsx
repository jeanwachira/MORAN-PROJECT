                    ...
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="rounded-2xl border border-stone-100 shadow-xl">
                                <DropdownMenuItem className="font-semibold rounded-xl"><Edit className="h-4 w-4 mr-2" />Edit</DropdownMenuItem>
            ...
            <div className="bg-white rounded-3xl border border-stone-100 shadow-sm p-5 mb-6">
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <Select value={filterServiceType} onValueChange={setFilterServiceType}>
                        <SelectTrigger className="w-52 h-10 rounded-2xl border-stone-200">
                            <Filter className="h-4 w-4 mr-2" style={{ color: GOLD }} />
                            <SelectValue placeholder="Filter by service type" />
                        </SelectTrigger>
                        <SelectContent className="rounded-2xl bg-white">
                            <SelectItem value="all">All Service Types</SelectItem>
                            {serviceTypes.map(t => <SelectItem key={t} value={t}><div className="flex items-center gap-2">{getServiceTypeIcon(t)}{t}</div></SelectItem>)}
                        </SelectContent>
                    </Select>
                </div>
            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Select value={newProvider.serviceType} onValueChange={v => handleSelectChange('serviceType', v)}>
                                    <SelectTrigger className={inputClass}><SelectValue placeholder="Select service type" /></SelectTrigger>
                                    <SelectContent className="rounded-2xl bg-white">
                                        {serviceTypes.map(t => <SelectItem key={t} value={t}><div className="flex items-center gap-2">{getServiceTypeIcon(t)}{t}</div></SelectItem>)}
                                    </SelectContent>
                                </Select>
